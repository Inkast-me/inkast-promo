<template>
  <section class="home__follow" id="follow">
    ...
    <div class="follow__social-wrapper">
      <a href="https://www.youtube.com/@inkast_me" class="youtube__icon">
        <svg
