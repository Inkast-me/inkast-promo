<template>
  ...
  <div class="privacy">
    ...
    <p>
      ...
      Самариной Аленой Игоревны (далее&nbsp;&mdash; Оператор).
    </p>
    <ul>
      <li>
      ...
      <li>
        ...
        <a href="https://inkast.me/">https://inkast.me/</a>.
      </li>
    </ul>
    ...
    <ul>
      ...
      <li>
        ...
        веб-сайта <a href="https://inkast.me/">https://inkast.me/</a>.
      </li>
      <li>
        2.9. Персональные данные, разрешенные субъектом персональных данных для
        распространения,&nbsp;&mdash; персональные данные, доступ
    ...
    <ul>
      ...
      <li>
        &mdash;&nbsp;принимать правовые, организационные и&nbsp;технические меры
    ...
    <ul>
      ...
      <li>
        ...
        и&nbsp;порядок ее&nbsp;получения установлен Законом о&nbsp;персональных
        данных;
      </li>
      <li>
      ...
      <li>
        ...
        Оператору недостоверные сведения о&nbsp;себе, либо сведения
        о&nbsp;другом субъекте персональных данных без согласия последнего,
    ...
    <ul>
      ...
      <li>
        ...
        с&nbsp;помощью сервисов интернет-статистики (Яндекс Метрика и&nbsp;Гугл
        Аналитика и&nbsp;других).
      </li>
      <li>
      ...
      <li>
        ...
        в&nbsp;ч.&nbsp;1&nbsp;ст.&nbsp;10&nbsp;Закона о&nbsp;персональных
      ...
      <li>
        ...
        информацию об&nbsp;условиях обработки, о&nbsp;наличии запретов
      ...
      <li>
        ...
        Оператору требования, указанного в&nbsp;п.&nbsp;5.7.3 настоящей Политики
    ...
    <ul>
      ...
      <li>
        ...
        в&nbsp;случае утраты необходимости в&nbsp;достижении этих целей, если
    ...
    <ul>
      ...
      <li>
        &mdash;&nbsp;предоставление доступа Пользователю к&nbsp;сервисам,
      ...
      <li>
        ...
        на&nbsp;адрес электронной почты info@inkast.me с&nbsp;пометкой
    ...
    <ul>
      ...
      <li>
        ...
        технологиях и&nbsp;о&nbsp;защите информации&raquo;
        от&nbsp;27.07.2006&nbsp;N 149-ФЗ;
      </li>
      <li>
        &mdash;&nbsp;федеральные законы, иные нормативно-правовые акты
        в&nbsp;сфере защиты персональных данных;
      </li>
      <li>
        &mdash;&nbsp;согласия Пользователей на&nbsp;обработку
      ...
      <li>
        ...
        <a href="https://inkast.me/">https://inkast.me/</a> или направленные
    ...
    <ul>
      ...
      <li>
        ...
        Оператора info@inkast.me с&nbsp;пометкой &laquo;Актуализация
      ...
      <li>
        ...
        info@inkast.me с&nbsp;пометкой &laquo;Отзыв согласия на&nbsp;обработку
        персональных данных&raquo;.
      </li>
      <li>
    ...
    <ul>
      <li>
        ...
        к&nbsp;Оператору с&nbsp;помощью электронной почты info@inkast.me.
      </li>
      <li>
      ...
      <li>
        ...
        <a href="https://inkast.me/privacy/">https://inkast.me/privacy/</a>.
      </li>
    </ul>
  </div>
